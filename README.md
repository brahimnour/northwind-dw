...
OLTP database into a SQL Server star-schema data warehouse using SSIS,
document the model in Oracle Data Modeler, explore it in Tableau, and
serve it through a custom Flask web application (not a BI tool —
...
NorthwindDW (star schema, SQL Server)
        │
        ├──▶ Tableau (live connection, BI dashboard)
...
- **Dashboarding**: Tableau (live connection)
...
house ledger rather than a generic admin dashboard templat
